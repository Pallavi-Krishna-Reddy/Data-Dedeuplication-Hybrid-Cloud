        ...
        <td width="20%" style="border-style: outset; border-width: 1px; padding: 1px" bgcolor="#FF0000">
            <p align="center"><font face="Bodoni MT Black" color="#FFFF00">
                <a href="ShareRequest.jsp"><font color="#FFFF00">
                    <span style="text-decoration: none; font-weight: 700">Share Request</span></font></a>&nbsp; </font>
        </td>
        <td width="20%" style="border-style: outset; border-width: 1px; padding: 1px" bgcolor="#FF0000"><font
                face="Bodoni MT Black" color="#FFFF00">
            &nbsp;<a href="logout.jsp"><span style="text-decoration: none"><font
                color="#FFFF00">Logout</font></span></a></font></td>
    </tr>
</table>
<p align="center">
    &nbsp;<%
    ...
    <table border="0" width="100%">
        <tr>
            <td width="50%" rowspan="6">
                <p align="center">Current Encrypted Data .<textarea rows="6" name="edata"
                                                                    cols="74"><%=sEdata%></textarea></td>
